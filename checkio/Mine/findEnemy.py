'''
Front: отсчет от меня -> i-ый вверх, на 1 + 2*(i-1) всторону
Back: отсчет от меня -> i-ый вниз, на (i-1) всторону
Right: i-ый вправо, вверх на 1 для i, (i+1)
                    вниз на 1 для (i+1), (i+2)

Left: отсчет от меня -> i-ый влево, вниз на i%2 + i//2
'''
