'''Напишите программу, которая считывает с клавиатуры два числа a и b,
 ...
 На вход программе подаются интервалы, внутри которых всегда есть хотя
 бы одно число, которое делится на 3.﻿'''

a, b = [int(input()) for i in range(2)]

sum = 0     # Сумма всех чисел, делящихся на 3
num = 0     # Всего чисел, делящихся на 3
